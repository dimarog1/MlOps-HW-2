...
- **REST API**: FastAPI с Swagger документацией, health checks (`/health`, `/ready`)
...
Краткое описание эндпоинтов (в т.ч. `/health` и `/ready` для проверки состояния и готовности сервиса) — в [API.md](API.md).
